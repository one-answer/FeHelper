!function(t) {
  ...
  t.defineMode("xml", function(r, o) {
      var a, i, l = r.indentUnit, u = {}, c = o.htmlMode ? e : n;
      for (var d in c)
          u[d] = c[d];
      for (var d in o)
          u[d] = o[d];
      function s(t, e) {
          ...
          var r = t.next();
          return "<" == r ? t.eat("!") ? t.eat("[") ? t.match("CDATA[") ? n(m("atom", "]]>")) : null : t.match("--") ? n(m("comment", "--\x3e")) : t.match("DOCTYPE", !0, !0) ? (t.eatWhile(/[\w\._\-]/),
          n(function t(e) {
              return function(n, r) {
                  for (var o; null != (o = n.next()); ) {
                      if ("<" == o)
                          return r.tokenize = t(e + 1),
                          r.tokenize(n, r);
                      if (">" == o) {
                          if (1 == e) {
                              r.tokenize = s;
      ...
      function h(t, e) {
          for (var n; ; ) {
              ...
              !u.contextGrabbers.hasOwnProperty(n) || !u.contextGrabbers[n].hasOwnProperty(e))
                  return;
              p(t)
          }
      }
      ...
      function b(t, e, n) {
          ...
          i = "tag",
          N) : u.allowMissingTagName && "endTag" == t ? (i = "tag bracket",
          N(t, e, n)) : (i = "error",
          b)
      }
      function k(t, e, n) {
          if ("word" == t) {
              var r = e.current();
              return n.context && n.context.tagName != r && u.implicitlyClosed.hasOwnProperty(n.context.tagName) && p(n),
              n.context && n.context.tagName == r || !1 === u.matchClosing ? (i = "tag",
              w) : (i = "tag error",
              v)
          }
      ...
      function N(t, e, n) {
          ...
          if ("endTag" == t || "selfcloseTag" == t) {
              ...
              "selfcloseTag" == t || u.autoSelfClosers.hasOwnProperty(r) ? h(n, r) : (h(n, r),
              n.context = new g(n,r,o == n.indented)),
              x
          }
          return i = "error",
          N
      ...
      function T(t, e, n) {
          return "equals" == t ? y : (u.allowMissing || (i = "error"),
          N(t, 0, n))
      }
      function y(t, e, n) {
          return "string" == t ? z : "word" == t && u.allowUnquoted ? (i = "string",
          N) : (i = "error",
          N(t, 0, n))
      }
      function z(t, e, n) {
          return "string" == t ? z : N(t, 0, n)
      }
      return s.isInText = !0,
      {
          ...
          indent: function(e, n, r) {
              ...
              if (o && o.noIndent)
                  return t.Pass;
              if (e.tokenize != f && e.tokenize != s)
                  return r ? r.match(/^(\s*)/)[0].length : 0;
              if (e.tagName)
                  return !1 !== u.multilineTagIndentPastTag ? e.tagStart + e.tagName.length + 2 : e.tagStart + l * (u.multilineTagIndentFactor || 1);
              if (u.alignCDATA && /<!\[CDATA\[/.test(n))
                  return 0;
              var a = n && /^<(\/)?([\w_:\.-]*)/.exec(n);
              if (a && a[1])
                  for (; o; ) {
                      ...
                      if (!u.implicitlyClosed.hasOwnProperty(o.tagName))
                          break;
                      o = o.prev
                  }
              else if (a)
                  for (; o; ) {
                      var i = u.contextGrabbers[o.tagName];
                      if (!i || !i.hasOwnProperty(a[2]))
                          break;
                      o = o.prev
                  }
